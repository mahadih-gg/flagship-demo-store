        ...
        <section className="telco-container">
          ...
          <div className="flex flex-col lg:flex-row gap-[60px] sm:gap-10 lg:gap-[50px] 2xl:gap-[73px]">
            ...
            <div className="w-full lg:w-[45%] xl:w-[51.81%] 2xl:w-[49%] 3xl:w-[51.81%]">
              ...
              />
              <div>
                <h3 className="text-xl md:text-2xl 2xl:text-2xl text-[#1D1D1F] font-bold mt-[60px] sm:mt-5 lg:mt-[60px] 2xl:mt-20 mb-6 lg:mb-[30px] 2xl:mb-10">
                  User Reviews
                </h3>
                <EntryPointWrapper
                  id="#842010"
                ...
                />
                <div className="pt-[60px] sm:pt-14 2xl:pt-[60px] 3xl:pt-20">
