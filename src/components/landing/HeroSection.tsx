...
const HeroSection = () => {
  ...
  return (
    <section className="landing-container-left flex flex-col lg:flex-row items-start justify-between gap-10 lg:gap-14 pt-[60px] md:pt-[90px] 3xl:pt-[120px]">
      ...
      {/* Right: Hero Image */}
      <div className="relative w-full lg:w-[40%] 2xl:w-[48%] ml-auto">
        <img
        ...
        <img src="/assets/images/landing/hero-short-lg.webp" alt="Landing Hero" className="block lg:hidden w-[calc(100%+100px)] sm:w-auto h-[410px] sm:h-auto object-cover object-left" />
